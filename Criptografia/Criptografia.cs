...
namespace SAS.Criptografia
{
    ...
    {
        private readonly bool _isSimetrica; // Encapsulamento: variável que define o tipo de criptografia
        private readonly Aes _aes; // Instância de criptografia simétrica
        private readonly RSA _rsa; // Instância de criptografia assimétrica

        // Construtor que inicializa a criptografia com base no tipo escolhido
        public Criptografia(bool isSimetrica)
        {
            ...
            if (_isSimetrica)
            {
                // Inicializa a criptografia simétrica AES - simetrica
                _aes = Aes.Create();
            ...
            {
                // Inicializa a criptografia assimétrica RSA - assimetrica
                _rsa = RSA.Create();
        ...
        // Métodos privados para criptografia simétrica
        ...
        // Métodos privados para criptografia assimétrica
